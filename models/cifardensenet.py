# Original code by Andreas Veit 2017 (BSD 3-Clause License) https://github.com/andreasveit/densenet-pytorch/blob/master/densenet.py
...
def densenet40_12_bc(**kwargs):
    model = DenseNet(depth=40, growth_rate=12, bottleneck=True, reduction=1, **kwargs)
    return model


def densenet40_12(**kwargs):
    model = DenseNet(depth=40, growth_rate=12, bottleneck=False, reduction=1, **kwargs)
    return model
